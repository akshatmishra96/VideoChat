...
import com.example.videochat.adapter.FriendListRecyclerViewAdapter;
import com.example.videochat.adapter.MessageAdapter;
import com.example.videochat.adapter.ShowFriendListRecyclerViewAdapter;
import com.example.videochat.layout.GridVideoViewContainer;
import com.example.videochat.layout.RecyclerItemClickListener;
import com.example.videochat.model.DBUser;
import com.example.videochat.model.MessageBean;
import com.example.videochat.model.MessageListBean;
import com.example.videochat.model.User;
import com.example.videochat.model.UserStatusData;
import com.example.videochat.rtm.AGApplication;
import com.example.videochat.rtm.ChatManager;
import com.example.videochat.utils.Constant;
import com.example.videochat.utils.MessageUtil;
...
public String appID="d0272eb3f6634389aefc9d2e9b102edf";
    ...
    private void initializeEngine() {
        try {
            mRtcEngine = RtcEngine.create(getBaseContext(),"d0272eb3f6634389aefc9d2e9b102edf", mRtcEventHandler);
        } catch (Exception e) {
