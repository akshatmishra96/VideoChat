package com.example.videochat.layout;
...
import com.example.videochat.model.VideoInfoData;
import com.example.videochat.model.VideoUserStatusHolder;
...
public class VideoViewAdapterUtil {
    ...
    public static void renderExtraData(Context context, UserStatusData user, VideoUserStatusHolder myHolder) {
        ...
        if (tag != null && System.currentTimeMillis() - (Long) tag < 1500) {
            return;
        }
